      ...
      <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-background/70 border-b border-border/60">
        <div className="container flex items-center justify-between h-16">
          <Link to="/" className="group inline-flex items-baseline gap-2">
            ...
            <span className="hidden sm:inline text-[10px] uppercase tracking-[0.35em] text-muted-foreground group-hover:text-foreground transition-colors">
              interiors
            </span>
          </Link>
          ...
          <a
            href="#consult"
            className="inline-flex items-center gap-2 rounded-full px-5 py-2 text-sm font-medium text-background bg-primary hover:brightness-110 transition shadow-[0_8px_24px_hsl(var(--primary)/0.25)]"
          >
      ...
      <footer id="contacts" className="border-t border-border/70 mt-24">
        <div className="container py-16 grid md:grid-cols-4 gap-10">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground max-w-xs">
              Нас рекомендуют тем, кто ценит качество и вкус. Дизайнерский
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="mailto:hello@sogroup.ru" className="hover:underline">
                  hello@sogroup.ru
                </a>
              </li>
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="p-2 rounded-full border border-border hover:border-foreground/40 transition-colors"
              >
        ...
        <div className="border-t border-border/70 py-6 text-xs text-muted-foreground">
          <div className="container flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
              © {new Date().getFullYear()} SO Group. Все права защищены.
            </div>
